...
//    public static final Banco BANCO = new Banco(1L, "Banco Unión", 0);
    ...
    public static Optional<Cuenta> crearCuenta002() {
        return Optional.of(new Cuenta(2L, "Carlos", new BigDecimal("2000")));
    }

    public static Optional<Banco> crearBanco() {
        return Optional.of(new Banco(1L, "Banco Unión", 0));
    }
}
