...
public class ReservationService {
    ...
    public ReservationDTO getReservationById(Long id) {
        ...
        if (result.isEmpty()) {
            ...
            throw new ErrException(APIError.RESERVATION_NOT_FOUND);
        }
    ...
    public ReservationDTO save(ReservationDTO reservation) {
        if (Objects.nonNull(reservation.getId())) {
            throw new ErrException(APIError.RESERVATION_WITH_SAME_ID);
        }
    ...
    private void checkCity(ReservationDTO reservationDTO) {
        for (SegmentDTO segmentDTO : reservationDTO.getItinerary().getSegment()) {
            ...
            if (origin == null || destination == null) {
                throw new ErrException(APIError.VALIDATION_ERROR);
            } else {
